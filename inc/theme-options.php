		...
		<?php do_settings_sections( 'rmdr_wp_theme-options' ); ?>
			...
			<table class="form-table">
				...
				<tr valign="top">
					<td>
						<label>
							<input name="rmdr_wp_theme-dark-mode" type="checkbox" value="1" <?php checked( '1', get_option( 'rmdr_wp_theme-dark-mode' ) ); ?> />
							<?php _e( 'Enable a dark theme style.', 'rmdr_wp_theme' ); ?>
...
function gutenberg_starter_theme_enable_editor_color_palette() {
	if ( get_option( 'rmdr_wp_theme-editor-color-palette', 1 ) == 1 ) {
		...
		add_theme_support( 'editor-color-palette', array(
			array(
				'name'  => __( 'Strong Blue', 'rmdr_wp_theme' ),
				'slug'  => 'strong-blue',
				'color' => '#0073aa',
			),
			array(
				'name'  => __( 'Lighter Blue', 'rmdr_wp_theme' ),
				'slug'  => 'lighter-blue',
				'color' => '#229fd8',
			),
			array(
				'name'  => __( 'Very Light Gray', 'rmdr_wp_theme' ),
				'slug'  => 'very-light-gray',
				'color' => '#eee',
			),
			array(
				'name'  => __( 'Very Dark Gray', 'rmdr_wp_theme' ),
				'slug'  => 'very-dark-gray',
				'color' => '#444',
			),
		) );
...
/**
 * Enable dark mode if rmdr_wp_theme-dark-mode setting is active.
 */
